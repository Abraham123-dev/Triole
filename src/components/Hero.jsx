      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="relative h-[500px] lg:h-[650px] w-full flex items-center justify-center lg:justify-end mt-10 lg:mt-0">
            ...
            <div className="absolute bottom-12 lg:bottom-20 right-[25%] lg:right-[35%] w-[280px] sm:w-[320px] bg-white p-3.5 rounded-[40px] shadow-card z-20 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-150">
